    ...
    public static void initialize() {
        try(Connection conn = SQLiteDatabase.connect()) {
            if(conn != null) {
                ...
                String orderSql = "CREATE TABLE IF NOT EXISTS orders(order_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, order_date TEXT NOT NULL, total_amount DOUBLE NOT NULL, is_included INTEGER DEFAULT 1)";
                ...
                String archiveProductSql = "CREATE TABLE IF NOT EXISTS archive_products(product_id INTEGER NOT NULL, product_name TEXT NOT NULL, product_price DOUBLE NOT NULL, archive_date DATE NOT NULL)";
                stmt.executeUpdate(archiveProductSql);

                String archiveProdIngSql = "CREATE TABLE IF NOT EXISTS archive_prod_ingrd(product_id INTEGER NOT NULL, item_id INTEGER NOT NULL, item_name TEXT NOT NULL, needed_quantity DOUBLE NOT NULL, unit_measure TEXT NOT NULL, archive_date DATE NULL)";
                stmt.executeUpdate(archiveProdIngSql);

                String archiveInventorySql = "CREATE TABLE IF NOT EXISTS archive_items(item_id INTEGER NOT NULL, item_name TEXT NOT NULL, stock_quantity DOUBLE NOT NULL, reorder_level DOUBLE NOT NULL, unit_measure TEXT NOT NULL, archive_date DATE NOT NULL)";
